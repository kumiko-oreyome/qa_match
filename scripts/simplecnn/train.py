...
simplecnn = SimpleCNN(train_dataset.vocab,args.emb_dim,parse_kernel_args(args.kernels))
...
leaner.train(train_loader,eval_loader,checkpoint,eva,max_epoch=args.epoch_num)